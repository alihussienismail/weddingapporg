        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (Input.ProfileImage != null && Input.ProfileImage.Length > 0)
            {
                try
                {
                    ...
                    var fileName = Guid.NewGuid().ToString() + "_" + Path.GetFileName(Input.ProfileImage.FileName);
                ...
                catch (Exception ex)
                {
                    ...
                    ModelState.AddModelError(string.Empty, "حدث خطأ في رفع الصورة. يرجى المحاولة مرة أخرى.");
                    return Page();
                }
            }
